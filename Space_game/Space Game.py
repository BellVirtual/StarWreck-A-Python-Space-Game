...
astro = Entity(model='astro1',collider='box',texture='rockytex' ,scale=(.5,.5,.5),rotation=(0,0,0),position=(random.randint(-6, 6),random.randint(-6, 6),poslist[0]))
astro2 = Entity(model='astro1',collider='box',texture='rockytex' ,scale=(.5,.5,.5),rotation=(0,0,0),position=(random.randint(-6, 6),random.randint(-6, 6),poslist[1]))
astro3 = Entity(model='astro1',collider='box',texture='rockytex' ,scale=(.5,.5,.5),rotation=(0,0,0),position=(random.randint(-6, 6),random.randint(-6, 6),poslist[2]))
astro4 = Entity(model='astro1',collider='box',texture='rockytex' ,scale=(.5,.5,.5),rotation=(0,0,0),position=(random.randint(-6, 6),random.randint(-6, 6),poslist[3]))
astro5 = Entity(model='astro1',collider='box',texture='rockytex' ,scale=(.5,.5,.5),rotation=(0,0,0),position=(random.randint(-6, 6),random.randint(-6, 6),poslist[4]))
